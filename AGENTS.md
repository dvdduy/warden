# AGENTS.md — Warden project briefing

> This file is read by Codex on every session. It contains the architecture rules,
...
Use these in Codex to start a scoped session:
